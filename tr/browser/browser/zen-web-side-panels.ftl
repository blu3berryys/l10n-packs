...
zen-web-side-panel-context-add-to-panel = 
    ...
    .accesskey = A
zen-webpanel-introduction-title = Zen Web Panellerine Hoşgeldiniz
zen-webpanel-introduction-description = Web Panelleri favori web sitelerinizi parmaklarınızın ucunda tutmanın bir yoludur.
